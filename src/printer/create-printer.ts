import ts, { 
    CompilerOptions, EmitHint, factory, ModuleKind, 
    NewLineKind, Printer, PrinterOptions, PrintHandlers, 
    ScriptTarget, SourceFile, SourceMapSource, sys, 
    Node, SyntaxKind, Bundle, UnparsedSource, ListFormat, 
    NodeArray, TypeNode, isVariableStatement, InputFiles, Identifier, Expression, StringLiteral, JsxExpression, isStringLiteral, EmitFlags, isSourceFile, isUnparsedSource, isUnparsedPrepend, isIdentifier, isTypeParameterDeclaration, LiteralExpression, PrivateIdentifier, QualifiedName, ComputedPropertyName, TypeParameterDeclaration, AccessorDeclaration, ArrayBindingPattern, ArrayLiteralExpression, ArrayTypeNode, ArrowFunction, AsExpression, AssertClause, AssertEntry, AwaitExpression, BigIntLiteral, BinaryExpression, BinaryOperatorToken, BindingElement, BindingPattern, Block, BlockLike, BreakStatement, CallExpression, CallSignatureDeclaration, CaseBlock, CaseClause, CaseOrDefaultClause, CatchClause, ClassDeclaration, ClassExpression, ClassStaticBlockDeclaration, CommaListExpression, CommentRange, ConditionalExpression, ConditionalTypeNode, ConstructorDeclaration, ConstructorTypeNode, ConstructSignatureDeclaration, ContinueStatement, DebuggerStatement, DeclarationName, Decorator, DefaultClause, DeleteExpression, DoStatement, DotToken, ElementAccessExpression, EntityName, EnumDeclaration, EnumMember, escapeLeadingUnderscores, ExportAssignment, ExportDeclaration, ExportSpecifier, ExpressionStatement, ExpressionWithTypeArguments, Extension, ExternalModuleReference, FileReference, forEachLeadingCommentRange, forEachTrailingCommentRange, ForInOrOfStatement, ForInStatement, ForOfStatement, ForStatement, FunctionDeclaration, FunctionExpression, FunctionLikeDeclaration, FunctionTypeNode, GeneratedIdentifierFlags, getCommentRange, getConstantValue, getEmitHelpers, getLeadingCommentRanges, getLineAndCharacterOfPosition, getOriginalNode, getParseTreeNode, getShebang, getSourceMapRange, getSyntheticLeadingComments, getSyntheticTrailingComments, getTextOfJSDocComment, getTrailingCommentRanges, HeritageClause, idText, IfStatement, ImportClause, ImportDeclaration, ImportEqualsDeclaration, ImportOrExportSpecifier, ImportSpecifier, ImportTypeNode, IndexedAccessTypeNode, IndexSignatureDeclaration, InferTypeNode, InterfaceDeclaration, IntersectionTypeNode, isArrowFunction, isBinaryExpression, isBlock, isEmptyStatement, isFunctionLike, isJsxClosingElement, isJsxOpeningElement, isLiteralExpression, isModuleDeclaration, isNumericLiteral, isParenthesizedExpression, isPartiallyEmittedExpression, isPrivateIdentifier, isTokenKind, isUnparsedNode, JSDoc, JSDocAugmentsTag, JSDocCallbackTag, JSDocComment, JSDocEnumTag, JSDocFunctionType, JSDocImplementsTag, JSDocNameReference, JSDocNonNullableType, JSDocNullableType, JSDocOptionalType, JSDocPropertyLikeTag, JSDocReturnTag, JSDocSeeTag, JSDocSignature, JSDocTag, JSDocTemplateTag, JSDocThisTag, JSDocTypedefTag, JSDocTypeExpression, JSDocTypeLiteral, JSDocTypeTag, JSDocVariadicType, JsxAttribute, JsxAttributes, JsxClosingElement, JsxClosingFragment, JsxElement, JsxFragment, JsxOpeningElement, JsxOpeningFragment, JsxSelfClosingElement, JsxSpreadAttribute, JsxTagNameExpression, JsxText, LabeledStatement, LiteralLikeNode, LiteralTypeNode, MappedTypeNode, MetaProperty, MethodDeclaration, MethodSignature, Modifier, ModuleBlock, ModuleDeclaration, ModuleReference, NamedDeclaration, NamedExports, NamedImports, NamedImportsOrExports, NamedTupleMember, NamespaceExport, NamespaceExportDeclaration, NamespaceImport, NewExpression, NodeFlags, NonNullExpression, NumericLiteral, ObjectBindingPattern, ObjectLiteralExpression, OptionalTypeNode, ParameterDeclaration, ParenthesizedExpression, ParenthesizedTypeNode, PartiallyEmittedExpression, PostfixUnaryExpression, PrefixUnaryExpression, PropertyAccessExpression, PropertyAssignment, PropertyDeclaration, PropertySignature, RestTypeNode, ReturnStatement, setOriginalNode, setTextRange, ShorthandPropertyAssignment, SignatureDeclaration, skipPartiallyEmittedExpressions, SpreadAssignment, SpreadElement, Statement, SwitchStatement, SymbolFlags, SynthesizedComment, TaggedTemplateExpression, TemplateExpression, TemplateLiteralTypeNode, TemplateLiteralTypeSpan, TemplateSpan, TextRange, ThrowStatement, tokenToString, TryStatement, TupleTypeNode, TypeAliasDeclaration, TypeAssertion, TypeLiteralNode, TypeOfExpression, TypeOperatorNode, TypePredicateNode, TypeQueryNode, TypeReferenceNode, UnionTypeNode, UnparsedNode, UnparsedPrepend, UnparsedPrologue, UnparsedSyntheticReference, UnparsedTextLike, VariableDeclaration, VariableDeclarationList, VariableStatement, VoidExpression, WhileStatement, WithStatement, YieldExpression
} from 'typescript';
...
function getEmitScriptTarget(compilerOptions: { module?: CompilerOptions[ "module" ], target?: CompilerOptions[ "target" ] }) {
...
function getEmitModuleKind(compilerOptions: { module?: CompilerOptions[ "module" ], target?: CompilerOptions[ "target" ] }) {
    return typeof compilerOptions.module === "number" ?
        compilerOptions.module :
        getEmitScriptTarget(compilerOptions) >= ScriptTarget.ES2015 ? ModuleKind.ES2015 : ModuleKind.CommonJS;
}

function noEmitNotification(hint: EmitHint, node: Node, callback: (hint: EmitHint, node: Node) => void) {
    callback(hint, node);
}

function noEmitSubstitution(_hint: EmitHint, node: Node) {
    return node;
}
...
type EmitTextWriter = any;
type BundleFileInfo = any;
type BundleFileTextLikeKind = any;

enum BundleFileSectionKind {
    Text = 0
}

export function createPrinter(printerOptions: CompilerOptions = {}, handlers: PrintHandlers = {}): Printer {
    const {
        hasGlobalName,
    ...
    const relativeToBuildInfo = bundleFileInfo ? printerOptions.relativeToBuildInfo : undefined;
